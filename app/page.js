...
export default function Home() {
  return (
    <>
      ...
      >
        ...
        <div className="relative z-10 max-w-2xl">
          <h1 className="text-3xl sm:text-4xl md:text-6xl font-bold mb-4 leading-tight">
            Building Spaces with Elegance
          </h1>
          <p className="text-sm sm:text-base md:text-xl text-gray-700 mb-4">
      ...
      {/* WHY US */}
      <section id="why" className="relative py-12 md:py-20 px-4 sm:px-6">
        {/* Background Image */}
        <div className="absolute inset-0">
          <Image
            src="/img13.jpeg"
      ...
      {/* CONTACT */}
      <section id="contact" className="relative py-12 md:py-20 px-4 sm:px-6">
        {/* Background Image */}
        <div className="absolute inset-0">
          <Image
            src="/img17.jpeg"  
      ...
      {/* FOOTER */}
      <footer className="bg-black text-white py-8 px-4 sm:px-6 text-center">
